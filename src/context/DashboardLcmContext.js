...
export const DashboardLcmProvider = ({ children, roleIds }) => {
  ...
  const {
    ...
    queryFn: () =>
      axiosInstance
        .get(`day_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
  ...
  const { data: pendingLcm = {}, isLoading: isPendingLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`pending_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
  ...
  const { data: expiredLcm = {}, isLoading: isExpiredLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`expired_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: paidLcm = {}, isLoading: isPaidLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`paid_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: ytdLcm = {}, isLoading: isYtdLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`year_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: pendingYtdLcm = {}, isLoading: isPendingYtdLoading } = useQuery(
    {
      ...
      queryFn: () =>
        axiosInstance
          .get(`pdyear_lcm?role_ids=${resolvedRoleIds}`)
          .then((res) => res.data),
      staleTime: 1000 * 60 * 60 * 1,
      cacheTime: 1000 * 60 * 60 * 2,
    }
  ...
  const { data: expiredYtdLcm = {}, isLoading: isExpiredYtdLoading } = useQuery(
    {
      ...
      queryFn: () =>
        axiosInstance
          .get(`exyear_lcm?role_ids=${resolvedRoleIds}`)
          .then((res) => res.data),
      staleTime: 1000 * 60 * 60 * 1,
      cacheTime: 1000 * 60 * 60 * 2,
    }
  ...
  const { data: paidYtdLcm = {}, isLoading: isPaidYtdLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`paiyear_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: totalLcm = {}, isLoading: isTotalLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`lcm_rt?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: totalMonthLcm = {}, isLoading: isTotalMonthLoading } = useQuery(
    {
      ...
      queryFn: () =>
        axiosInstance
          .get(`lcm_monthrt?role_ids=${resolvedRoleIds}`)
          .then((res) => res.data),
      staleTime: 1000 * 60 * 60 * 1,
      cacheTime: 1000 * 60 * 60 * 2,
    }
  ...
  const { data: grafikStudentLcm = {}, isLoading: isGrafikLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`stulast_year_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: grafikRevenueLcm = {}, isLoading: isGrafikRLoading } = useQuery(
    {
      ...
      queryFn: () =>
        axiosInstance
          .get(`pailast_year_lcm?role_ids=${resolvedRoleIds}`)
          .then((res) => res.data),
      staleTime: 1000 * 60 * 60 * 1,
      cacheTime: 1000 * 60 * 60 * 2,
    }
  ...
  const { data: studentY = {}, isLoading: isRevenueYLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`mrlc_rt?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: studentM = {}, isLoading: isRevenueMLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`mrlc_monthrt?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const { data: sourceLcm = {}, isLoading: isSourceLcmLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`source_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });

  const { data: waitTodayLcm = {}, isLoading: isWaitTodayLcmLoading } =
    useQuery({
      queryKey: ["wait_lcm", resolvedRoleIds],
      queryFn: () =>
        axiosInstance
          .get(`wait_lcm?role_ids=${resolvedRoleIds}`)
          .then((res) => res.data),
      staleTime: 1000 * 60 * 60 * 1,
      cacheTime: 1000 * 60 * 60 * 2,
    });
  ...
  const { data: waitYearLcm = {}, isLoading: isWaitYearLcmLoading } = useQuery({
    ...
    queryFn: () =>
      axiosInstance
        .get(`waityear_lcm?role_ids=${resolvedRoleIds}`)
        .then((res) => res.data),
    staleTime: 1000 * 60 * 60 * 1,
    cacheTime: 1000 * 60 * 60 * 2,
  });
  ...
  const isAnyLoading =
    ...
    isRevenueMLoading ||
    isSourceLcmLoading ||
    isWaitTodayLcmLoading ||
    isWaitYearLcmLoading ||
    isTotalMonthLoading;

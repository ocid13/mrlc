...
(function () {
  ...
  const revenueStatistics = document.querySelector("#revenueStatistics"),
    orderRevenueConfig = {
      chart: {
        height: 165,
        width: 130,
      ...
      labels: ["Electronic", "Sports", "Decor", "Test"],
      series: [85, 15, 50, 50],
      colors: [
        config.colors.primary,
        config.colors.secondary,
  ...
  if (typeof revenueStatistics !== undefined && revenueStatistics !== null) {
    const statisticsChart = new ApexCharts(
      revenueStatistics,
      orderRevenueConfig
    );
